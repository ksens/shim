...
## No support for SciDB native authentication

The shim still provides tls and basic digest authentication. If you need to use SciDB
authentication, then use the jquery or iquery client.

## Streaming and compression have been disabled
